    ...
    <div class="formulario">
      <form action="#" method="post">
        <fieldset>
          ...
          <input type="password" id="senha" name="senha" minlength="8" maxlength="16" required>
    
          <div class="botoes">
            <button class="botao_cadastro" type="submit">Entar</button>
